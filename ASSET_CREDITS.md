...
| --- | --- | --- | --- | --- | --- |
| `assets/environment/props/food_drink_2d_mega_props/Tiles/` | nacl1234; pack README discloses AI-assisted artwork | Food & Drink 2D Mega Props Pack v1.0, supplied by project owner; source URL not supplied | Supplied commercial license, retained at `assets/environment/props/food_drink_2d_mega_props/LICENSE.txt` | Selection of 38 PNGs for estate dressing; Godot atlas regions, scaling and tint; source files unchanged | No specific credit wording required in supplied license; original copyright is 2026 nacl1234 |
